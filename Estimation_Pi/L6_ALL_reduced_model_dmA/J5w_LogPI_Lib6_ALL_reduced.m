function Sum_prediction_error = J5w_LogPI_Lib6_ALL_reduced(params,model_c,Use_mean,ExpData_Tensor_lib30_micro,ParamsData_lib24,HEM,num_run,RBS_inv_sigma0,delta)
%% J5w_LogPI_Lib6_ALL_reduced
% Evaluate the Lib6 all-construct reduced-model objective.
%
% DESCRIPTION
%   Computes the weighted pseudo-Huber objective over the six B0034
%   constructs. The fitted scalar is the shared B0034 intrinsic initiation
%   capacity, kappa^0.
%
%   The selected d_mA value enters through model_c.dm_c. Promoter rate and
%   effective copy number are inherited from the matching Lib24 Monte Carlo
%   sample indexed by num_run.
%
% OUTPUT
%   Sum_prediction_error    Scalar objective value.
%
% The function is deterministic for fixed inputs and produces no files or
% figures.
