...
%PLOT_RESULTS_LIB_REDUCED_MODEL Plot reduced-model parameter and prediction results.
%
%   Compatible with compiled reduced-model result tensors that provide:
%       Gene_cn_raw, Gene_cn_mean,
%       Omega_raw, Omega_mean,
%       RBS_k0_sigma0_raw, RBS_k0_sigma0_mean,
%       MC_mu_slices, and global experimental Pi(mu) summaries.
%
%   The first seven arguments preserve the historical SynTwin calling
%   convention. Optional name-value arguments control output paths, export,
%   fonts, histogram bins, and figure geometry.
%
% MAIN OUTPUTS
%   1. Effective pGreen copy-number histogram.
%   2. Promoter-strength histograms.
%   3. RBS intrinsic initiation-capacity histograms.
%   4. Experimental-versus-predicted Pi(mu) tiles.
%
% EXAMPLE
%   Plot_Results_Lib_reduced_model(R,LB,UB,[1 2],[1 2 3],[1 2 4 5],'', ...
%       'OutputDir',fullfile(SCRIPT_DIR,'Figures'), ...
%       'FigurePrefix','Lib24_ALL_reduced', ...
%       'SaveFigures',true);
%
...
end % function Plot_Results_Lib_reduced_model
