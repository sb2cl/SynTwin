...
% Visualize the distributed Lib6 leave-one-out reduced-model results.
%
% Loads Results_Tensor_Lib6_L1O_reduced_Wells.mat and calls
% Plot_Results_Lib6_reduced_model to generate:
%
%   - the pooled B0034 kappa^0 histogram;
%   - six experimental-versus-predicted synthesis-rate panels.
%
% USAGE
%   Show_Results_Lib6_L1O_reduced_model
%
...
results_file = fullfile(SCRIPT_DIR,'Results_Tensor_Lib6_L1O_reduced_Wells.mat');
S = load(results_file);
if ~isfield(S,'Results_Tensor_Lib6_L1O_reduced')
    error('Show_Results_Lib6_L1O_reduced_model:MissingVariable', ...
        'Expected variable Results_Tensor_Lib6_L1O_reduced in %s.', results_file);
end
Results_Tensor_Lib6_L1O_reduced = S.Results_Tensor_Lib6_L1O_reduced;
...
Plot_Results_Lib6_reduced_model(Results_Tensor_Lib6_L1O_reduced, ...
        Lower_Bounds,Upper_Bounds,indices_plasmids,indices_promoters,indices_rbss,title_text, ...
        'OutputDir',OUTPUT_DIR, ...
        'FigurePrefix','Lib6_L1O_reduced_Wells', ...
        'SaveFigures',true, ...
        'BaseFontSize',26, ...
        'TileFontSize',18, ...
        'AxisLabelFontSize',24,...
        'FigRBSSizeCm',[45 30],...
        'FigTilesSizeCm',[75 30]);
