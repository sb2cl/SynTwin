...
%   Generate_Results_Lib6_L1O_reduced_model and produces representative plots:
...
load(fullfile(SCRIPT_DIR,'Results_Tensor_Lib6_L1O_reduced_Wells.mat'));
...
% param bounds:
 ...
 title_text = 'Lib6. L1O. RM.';
 Plot_Results_Lib6_reduced_model(Results_Tensor_Lib6_L1O_reduced,Lower_Bounds,Upper_Bounds,indices_plasmids,indices_promoters,indices_rbss, title_text)
