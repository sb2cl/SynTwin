...
% SynTwin workflow script: visualization of Lib5 ALL reduced-model results.
%
% DESCRIPTION
...
load(fullfile(SCRIPT_DIR,'Results_Tensor_Lib5_ALL_reduced_Wells.mat'));
...
num_rbss_Lib5 = length(indices_rbss_lib5);
 ...
 title_text = 'Lib5. ALL. RM.';
 Plot_Results_Lib5_reduced_model(Results_Tensor_Lib5_ALL_reduced,Lower_Bounds,Upper_Bounds,indices_plasmids_lib5,indices_promoters_lib5,indices_rbss_lib5, title_text)
