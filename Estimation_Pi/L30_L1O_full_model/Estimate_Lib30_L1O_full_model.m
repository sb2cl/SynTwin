...
%   ./Estimated_results/Results_BADS_Lib30_L1O_full_model_<Use_mean>.mat
...
%   - Uses: J4_LogPI_Lib30_L1O_full_model (objective function)
...
% params: vector of estimated parameters of the model
    ...
    % params(4:8) = RBS_k0_sigma0, RBS strengths over sensitivities (translational intrinsic initiation capacity)  of (B0030, B0032, B0034, J61100, J61101)
    ...
    for j=1:length(indices_promoters_lib30)
        for k=1:length(indices_rbss_lib30)
                ...
                parfor num_run=1:num_runs 
                    J=@(parameters) J4_LogPI_Lib30_L1O_full_model(parameters,Construct_2_LO,model_c,Use_mean,ExpData_Tensor_lib30_micro,HEM);
                    [params, Jmin_value] = bads(J,x0,lb,ub,plb,pub,[],options)
                     Results_BADS_Lib30_L1O_complete_v2{num_run}.results=[params, Jmin_value]; 
                end
                ...
                save(file_tensor, "Results_BADS_Lib30_L1O_complete_v2", "-mat");
