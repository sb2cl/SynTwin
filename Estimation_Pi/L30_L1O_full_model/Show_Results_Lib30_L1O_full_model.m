%% Show_Results_Lib30_L1O_full_model
% SynTwin workflow script: visualization of Lib30 L1O full-model results.
%
% DESCRIPTION
%   Loads the compiled Results tensor generated by
%   Generate_Results_Lib30_L1O_full_model and produces representative plots:
...
% Generate_Results_Lib30_L1O_full_model.m and stored in this same folder
% CHANGE BETWEEN Global, Instances and Wells appropriately
load(fullfile(SCRIPT_DIR,'Results_Tensor_Lib30_L1O_full_model_Instances.mat'));
...
Upper_Bounds = [0.15,0.35,0.35... %upper expected bounds for omega, promoter strengths,
 ...
 title_text = 'Lib30. L1O. FM. ';

Plot_Results_Lib_complete_model(Results_Tensor_Lib30_L1O_complete,Lower_Bounds,Upper_Bounds,indices_plasmids,indices_promoters,indices_rbss, title_text)
