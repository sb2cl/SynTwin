...
% Evaluate the all-construct Lib6 reduced-model objective.
%
% DESCRIPTION
%   Computes the weighted pseudo-Huber objective over the six B0034 constructs.
%   The fitted scalar is the shared B0034 intrinsic initiation capacity,
%   kappa^0. For each optimization run, promoter rate and effective copy number
%   are fixed to the corresponding inherited Lib24 Monte Carlo samples.
%
% COST FUNCTION
%   Residuals are evaluated in base-10 logarithmic synthesis-rate space and
%   averaged over growth-rate points, replicates, and all six constructs.
%
% OUTPUT
